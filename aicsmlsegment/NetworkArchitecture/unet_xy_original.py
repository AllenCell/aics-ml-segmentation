...
class UNet3D(nn.Module):
    def __init__(self, in_channel, n_classes, test_mode, batchnorm_flag=True):
        ...
        self.up3 = nn.ConvTranspose3d(
            512, 512, kernel_size=2, stride=2, padding=0, output_padding=0, bias=True
        )
        self.dc3 = self.decoder(256 + 512, 256, batchnorm=batchnorm_flag)
        self.up2 = nn.ConvTranspose3d(
            256, 256, kernel_size=2, stride=2, padding=0, output_padding=0, bias=True
        )
        self.dc2 = self.decoder(128 + 256, 128, batchnorm=batchnorm_flag)
        self.up1 = nn.ConvTranspose3d(
            128, 128, kernel_size=2, stride=2, padding=0, output_padding=0, bias=True
        )
